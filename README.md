...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/abraryaser02/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/abraryaser02/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/abraryaser02/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/abraryaser02/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/abraryaser02/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/abraryaser02/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_denormalized`      |    9.87s                  |      4.07s                | 
| `pg_normalized_batch`  |    471.32s                |      63.59s               | 
| `pg_normalized`        |    175.77s                |      14.39s               | 
